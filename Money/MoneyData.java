...
public class MoneyData {
    ...
    public static HashMap<User, LocalDateTime> Hour = new HashMap<>();
    public static HashMap<User, LocalDateTime> timeMonthly = new HashMap<>();
    public static HashMap<User, LocalDateTime> timeMinute = new HashMap<>();
